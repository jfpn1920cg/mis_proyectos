...
var vida_enemigo_scale_x = 3; // Escala horizontal (ajustar según sea necesario)
var vida_enemigo_scale_y = 3; // Escala vertical (ajustar según sea necesario)

// Dibujar la parte de la barra de vida del enemigo con la escala ajustada
draw_sprite_ext(spr_barra_de_vida_del_enemigo_parte_1, vida_enemigo_frame, 1395, 13, vida_enemigo_scale_x, vida_enemigo_scale_y, 0, c_white, 1);

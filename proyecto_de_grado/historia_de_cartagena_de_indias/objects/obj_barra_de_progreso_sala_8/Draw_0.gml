...
var total_frames = sprite_get_number(spr_barra_de_progreso_sala_8); // Obtener el total de frames del sprite
...
var scale_x = bar_width / sprite_get_width(spr_barra_de_progreso_sala_8);
var scale_y = bar_height / sprite_get_height(spr_barra_de_progreso_sala_8);

// Dibujar el sprite de la barra de carga con el tamaño y frame correspondientes al progreso
draw_sprite_ext(spr_barra_de_progreso_sala_8, current_frame, bar_x, bar_y, scale_x, scale_y, 0, c_white, 1);

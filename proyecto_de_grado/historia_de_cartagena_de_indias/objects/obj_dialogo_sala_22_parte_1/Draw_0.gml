...
if (variable_instance_exists(self, "texto"))
{
    ...
    draw_sprite_ext(sprite_actual, 0, 47, 452, ancho_sprite / sprite_get_width(sprite_actual), altura_sprite / sprite_get_height(sprite_actual), 0, c_white, 1);  // Ajusta la posición y escala según tus necesidades

...
draw_sprite_ext(spr_barra_de_vida_del_jugador_parte_4, vida_jugador_frame, 13, 13, vida_jugador_scale_x, vida_jugador_scale_y, 0, c_white, 1);
...
draw_sprite_ext(spr_barra_de_vida_del_enemigo_parte_4, vida_enemigo_frame, 1534, 11 , vida_enemigo_scale_x, vida_enemigo_scale_y, 0, c_white, 1);

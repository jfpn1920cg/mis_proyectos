...
if (keyboard_check_pressed(ord("E"))) {
    sprite_index = spr_jugador_5_pelea; // Cambia el sprite del jugador a la animación de pelea
    ...
    if (sprite_index == spr_jugador_5_pelea && !moving_to_enemy) {
        var direction_to_enemy = point_direction(x, y, obj_enemigos_4.x, obj_enemigos_4.y);

...
if (keyboard_check_pressed(ord("F"))) {
    var arma = instance_place(x, y, obj_resortera_arma); // Verifica si hay un arma en la ubicación del jugador
    if (arma != noone) {
...
with (obj_enemigos_4) {
    if (place_meeting(x, y, obj_resorteraso_arma)) {
        ...
        instance_destroy(obj_resorteraso_arma); // Destruye la flecha después de colisionar con el enemigo
    }
}
